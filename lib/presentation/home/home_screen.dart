...
GestureDetector(
  ...
  child: Stack(
    children: [
      ...
      if (ref.watch(appNotificationsProvider).where((n) => !n.isRead).isNotEmpty)
        Positioned(
          right: 0, top: 0,
          child: Container(
            width: 10, height: 10,
            decoration: const BoxDecoration(color: Color(0xFFFF1744), shape: BoxShape.circle),
              ...
              // Fuel cards — fixed height instead of Expanded
              SizedBox(
                height: 280,
              ...
              // Wallet Card — now fully tappable
              InkWell(
                onTap: () {
  ...
  Widget _fuelCard(BuildContext context, WidgetRef ref, String type, double price) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text('₹${price.toStringAsFixed(2)}/L',
                    style: TextStyle(
  ...
  _FuelConfig _fuelConfig(String type) {
    switch (type) {
      case 'petrol':
        return _FuelConfig('Petrol', Icons.local_gas_station_rounded, const Color(0xFFFF6B35));
      case 'diesel':
        return _FuelConfig('Diesel', Icons.local_shipping_rounded, const Color(0xFFFFD600));
      case 'cng':
        return _FuelConfig('CNG', Icons.ac_unit_rounded, const Color(0xFF00C853));
      case 'ev_charge':
        return _FuelConfig('EV Charge', Icons.electric_car_rounded, const Color(0xFF448AFF));
      default:
